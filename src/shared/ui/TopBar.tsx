...
export function TopBar({
  ...
  return (
    <div className="flex h-[50px] flex-shrink-0 items-center px-3">
      {/* Left: back button (44×44 hit target) or balance spacer */}
      {hasLeft ? (
        <button
          onClick={onBack}
          className="grid h-11 w-11 flex-shrink-0 place-items-center rounded-lg text-white focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-accent"
      ...
      {title && (
        <h1
          className={[
            'flex-1 text-[17px] font-semibold tracking-tight text-white',
